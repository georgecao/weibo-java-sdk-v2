...
public class Commons extends Weibo {
    ...
    public String codesToLocation(Collection<String> codes) throws WeiboException {
     ...
     */
    public String codesToLocation(String codes) throws WeiboException {
    ...
    public Map<String, String> getCities(String province, String capital, Lang language) throws WeiboException {
        ...
        Map<String, String> codeToNameMap = new HashMap<String, String>(array.length());
